...
namespace AspNetCore.Client.Generator.Framework.Http
{
	...
	/// </summary>
	public class HttpEndpoint : IResponseTypes, IHeaders, IIgnored, IObsolete, INavNode, IAuthorize
	{
		/// <summary>
		...
		/// </summary>
		public HttpController Parent { get; set; }
		...
		public HttpEndpoint(HttpController parent)
		{
			Parent = parent;
		}
		...
		/// </summary>
		public string GetFullRoute(HttpController caller)
		{
		...
		/// <returns></returns>
		public IEnumerable<RouteConstraint> GetRouteConstraints(HttpController caller)
		{
		...
		/// <param name="caller"></param>
		/// <returns></returns>
		public string ToString(HttpController caller)
		{
