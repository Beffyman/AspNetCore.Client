		...
		public void ConfigureServices(IServiceCollection services)
		{
			services.AddControllers()
				.AddMvcOptions(option =>
				{
					...
					option.OutputFormatters.Add(new MessagePackOutputFormatter(TypelessContractlessStandardResolver.Options));
					option.InputFormatters.Clear();
					option.InputFormatters.Add(new MessagePackInputFormatter(TypelessContractlessStandardResolver.Options));
				});
